# blueberryx-ios-sdk
Sample swift code snippets for connecting to Blueberry
...
func ctrlLCD(_ hexValue: UInt8){

    // Check if it has the write property
    if lcdCtrlChar!.properties.contains(.write) && peripheral != nil {

        self.peripheral.writeValue(Data([hexValue]), for: lcdCtrlChar!, type: .withResponse)
